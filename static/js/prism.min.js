/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+apacheconf+arduino+aspnet+bash+batch+c+csharp+cpp+css-extras+dart+django+docker+ejs+git+go+graphql+groovy+haskell+http+java+js-extras+kotlin+latex+less+liquid+lisp+lua+markup-templating+mongodb+n4js+nasm+nginx+ocaml+php+php-extras+powershell+pug+python+jsx+tsx+regex+ruby+rust+sass+scss+scala+solidity+sql+twig+typescript+typoscript+vim+yaml&plugins=line-highlight+normalize-whitespace+toolbar+copy-to-clipboard */
